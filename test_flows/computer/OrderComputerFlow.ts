...
import { ComputerDataType } from "@data/ComputerDataType";
...
import defaultCheckoutUser from '@data/defaultCheckoutUser.json';
import defaultCheckoutCard from '@data/defaultCheckoutCard.json';
...
export default class OrderComputerFlow {
    ...
    public async selectShippingMethod() {
        await test.step('Select Shipping Method', async () => {
            ...
            if (!randomShippingMethodLocator) {
